...
public class Register extends AppCompatActivity {
    ...
    NetworkInfo nInfo;
    private EditText email, password, cPassword, name, phone, dob, address;
    private Button signup;
    String user_email, user_password, user_cPassword, user_name, user_phone, user_dob, user_address;
                    ...
                    if (paswordlength()) {
                        if(paswordmatch()){
                            if (nInfo != null && nInfo.isConnected()) {
                                ...
                                final String gender_user = dob.getText().toString().trim();
    ...
    private Boolean validate(){
        ...
        if(user_name.isEmpty() || user_password.isEmpty() || user_email.isEmpty() || user_dob.isEmpty() ||
    ...
    public void onBackPressed() {
        startActivity(new Intent(Register.this, AccessType.class));
