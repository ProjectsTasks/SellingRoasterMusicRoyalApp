...
public class UpdateProfile extends AppCompatActivity {
    ...
    private EditText u_age, u_fname, u_phone, u_add;
    ...
    String us_age, us_fname, us_phone, us_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        u_age= (EditText) findViewById(R.id.uv_age3);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    u_age.setText(userInformation.getUserDOB());
                ...
                if(user!=null){
                    if (validate()) {
                        if (nInfo != null && nInfo.isConnected()) {
                            UserInformation userInformation = new UserInformation(us_fname, us_phone, us_add,us_age);
    ...
    private Boolean validate(){
        ...
        us_age = u_age.getText().toString();
        us_fname = u_fname.getText().toString();
        us_phone=u_phone.getText().toString();
        us_add= u_add.getText().toString();
        if(us_age.isEmpty() ||  us_fname.isEmpty() || us_phone.isEmpty() || us_add.isEmpty()){
